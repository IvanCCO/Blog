      ...
      <main className="main space-y-6 px-0">
        <VStack spacing={1} >
          <Image
            ...
            objectFit="cover"
          />
          <Text fontSize={"xs"} color={"GrayText"}>Image generated by Bing</Text>
        </VStack>
        <div className="flex-col space-y-5 px-6">
          {/* Titulo */}
          <Text fontSize={"2xl"} fontWeight={"semibold"}>Introdução ao Kubernetes: Orquestração de Contâiners</Text>
